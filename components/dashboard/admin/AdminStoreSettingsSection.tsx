...
interface AdminStoreSettingsSectionProps {
  storeSettings: StoreSettings;
  onSaveStoreSettings: (settings: StoreSettings) => void;
}

const AdminStoreSettingsSection: React.FC<AdminStoreSettingsSectionProps> = ({ storeSettings, onSaveStoreSettings }) => {
    ...
    <div className="space-y-8">
      ...
      <div className="bg-admin-card dark:bg-dark-admin-card p-6 rounded-2xl shadow-admin-soft">
        ...
        <div className="mt-6 text-right">
          <button onClick={handleSave} className="bg-admin-accent text-white font-semibold py-2 px-5 rounded-lg hover:bg-admin-accent-hover transition">
            Save Store Info
          </button>
        </div>
      </div>
...
export default AdminStoreSettingsSection;