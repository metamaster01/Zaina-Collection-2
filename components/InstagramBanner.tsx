...
const InstagramBanner: React.FC = () => {
  ...
  return (
    <section className="bg-white py-16">
      ...
      <div className="container mx-auto px-4 mb-16">
        {/* First Row - Discover Your New Favorites */}
        <div className="flex flex-col lg:flex-row items-center justify-center mb-16 gap-4 lg:gap-12">
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-blue-600 text-center sm:text-left">
              Discover Your
            </h2>
            <div className="relative">
              <div className="w-32 h-20 sm:w-40 sm:h-24 bg-gradient-to-r from-orange-400 to-yellow-400 rounded-full"></div>
              <img
                src="/bag.png"
                alt="Decorative handbag"
                className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-36 h-28 sm:w-48 sm:h-36 object-contain z-10"
              />
            </div>
          </div>
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-blue-600 text-center sm:text-left">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-12">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-blue-600 text-center lg:text-left">
            Life by Personalized Shopping
          </h2>
          <div className="relative">
            <div className="w-32 h-20 sm:w-40 sm:h-24 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full"></div>
            <img
              src="/girl.png"
              alt="Woman in traditional clothing"
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-36 h-28 sm:w-48 sm:h-36 object-cover rounded-full z-10"
            />
          </div>
        </div>
      </div>
        ...
        >
          <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center">
            <div className="mb-8 md:mb-0">
              ...
              <p className="text-xl md:text-2xl text-white">Follow us @zaina_collection_orginal to know more</p>
            </div>

            <button
              onClick={handleInstagramClick}
              className="bg-white text-black px-8 py-4 rounded-xl font-semibold hover:bg-gray-100 transition-colors duration-300 flex items-center gap-3 text-lg"
            >
              Follow us
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M7 17L17 7M17 7H7M17 7V17" />
