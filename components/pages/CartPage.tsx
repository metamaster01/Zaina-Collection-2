...
import { CartItem, PageName } from '../../types';
...
const CartPage: React.FC<CartPageProps> = ({ navigateToPage, initialCartItems, updateCartItems }) => {
  ...
  const shippingCost = 0; // always free
  ...
  const trustBadgesData = [
    {
      ...
      iconColor: 'text-zaina-primary dark:text-dark-zaina-primary',
    },
    {
      Icon: ExchangeIcon,
  ...
  if (cartItems.length === 0) {
    return (
      <div className="bg-zaina-sky-blue-light dark:bg-dark-zaina-neutral-light min-h-screen py-12 md:py-16 font-body-jost flex flex-col items-center justify-center">
        <h1 className="text-3xl md:text-4xl font-heading-playfair font-bold text-zaina-text-primary dark:text-dark-zaina-text-primary mb-6">
          Your Cart is Empty
        </h1>
        <p className="text-zaina-text-secondary dark:text-dark-zaina-text-secondary mb-8">
    ...
    <div className="bg-zaina-sky-blue-light dark:bg-dark-zaina-neutral-light min-h-screen py-8 md:py-12 font-body-jost">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <header className="text-center mb-8 md:mb-12">
          <h1 className="text-4xl md:text-5xl font-heading-playfair font-bold text-zaina-text-primary dark:text-dark-zaina-text-primary">
            Shopping Cart
          </h1>
        </header>
        ...
        <div className="grid lg:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            {cartItems.map(item => (
              <div
                ...
                className="flex flex-col sm:flex-row items-center gap-4 bg-zaina-white dark:bg-dark-zaina-bg-card p-4 rounded-lg shadow-md"
              >
                <img
                ...
                <div className="flex-grow text-center sm:text-left">
                  <h2
                    className="text-lg font-semibold text-zaina-text-primary dark:text-dark-zaina-text-primary hover:text-zaina-primary dark:hover:text-dark-zaina-primary transition-colors cursor-pointer"
                    onClick={() => navigateToPage('productDetail', item)}
                  >
                    {item.name}
                  </h2>
                  ...
                  <p className="text-sm text-zaina-gold dark:text-zaina-gold font-medium">
                ...
                <div className="flex items-center gap-2 my-2 sm:my-0">
                  <button
                    onClick={() =>
                      updateQuantity(item.selectedVariant.id, item.quantity - 1)
                    }
                    className="px-2 py-0.5 border rounded-md text-zaina-primary dark:text-dark-zaina-primary hover:bg-zaina-sky-blue-light/50 dark:hover:bg-dark-zaina-sky-blue-light/30 focus:outline-none focus:ring-1 focus:ring-zaina-primary dark:focus:ring-dark-zaina-primary"
                  >
                    -
                  </button>
                ...
                <p className="font-semibold text-zaina-text-primary dark:text-dark-zaina-text-primary w-20 text-center sm:text-right">
                  ₹{(item.selectedVariant.price * item.quantity).toFixed(2)}
                </p>
                <button
                  onClick={() => removeItem(item.selectedVariant.id)}
                  className="text-zaina-text-secondary dark:text-dark-zaina-text-secondary hover:text-zaina-deep-red-accent p-1"
                  title="Remove item"
                >
          ...
          <div className="lg:col-span-1 bg-zaina-white dark:bg-dark-zaina-bg-card p-6 rounded-lg shadow-xl h-fit lg:sticky lg:top-28">
            <h2 className="text-2xl font-heading-cormorant font-semibold text-zaina-text-primary dark:text-dark-zaina-text-primary mb-6">
              Order Summary
            </h2>
            <div className="space-y-3 mb-6">
              <div className="flex justify-between">
                <span className="text-zaina-text-secondary dark:text-dark-zaina-text-secondary">
                  Subtotal
                </span>
