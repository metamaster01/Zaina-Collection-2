...
const AdminDashboardPage: React.FC<AdminDashboardPageProps> = (props) => {
  const {
    ...
    onDeleteHeroSlide,
    shoppableVideos,
    onSaveShoppableVideo,
    onDeleteShoppableVideo,
    testimonials,
    onSaveTestimonial,
    onDeleteTestimonial,
    occasions,
  ...
  const [stockUpdateTarget, setStockUpdateTarget] = useState<{
    product: Product;
    variantSku?: string;
  } | null>(null);
  ...
  const handleViewOrder = async (summary: Order) => {
    setLoadingOrderId(summary.id);
    try {
      ...
      console.error(e);
      // Fallback: open with summary so the modal shows at least the header, but items may be empty
      setViewingOrder(summary);
    } finally {
  ...
  const renderActiveTabContent = () => {
    switch (activeTab) {
      // Main
      case "dashboard":
        return <AdminOverviewSection navigateToPage={navigateToPage} />;
      case "notifications":
        return (
          <AdminNotificationsSection onNotificationClick={handleNavLinkClick} />
        );
      ...
      case "orders_tracker":
        return (
          <AdminOrderStatusTrackerSection
            orders={allOrders}
            onUpdateStatus={onUpdateOrderStatus}
          />
        );
      ...
      case "products_all":
        return (
          <AdminProductManagementSection onEditProduct={handleEditProduct} />
        );
      case "products_add":
        return (
      ...
      case "products_tags":
        return <AdminTagsSection products={products} />;
      case "products_variants":
        return (
          <AdminVariantsSection
            attributes={variantAttributes}
            onSaveAttribute={onSaveVariantAttribute}
            onDeleteAttribute={onDeleteVariantAttribute}
            onAddValue={onAddValueToAttribute}
            onDeleteValue={onDeleteValueFromAttribute}
          />
        );
      case "inventory_all":
        return (
          <AdminInventorySection
            products={products}
            onUpdateStockClick={(p, v) =>
              setStockUpdateTarget({ product: p, variantSku: v })
            }
          />
        );
      case "inventory_upload":
        return (
          <AdminBulkUploadSection
            products={products}
            onBulkSaveProducts={onBulkUploadProducts}
          />
        );
      case "customers_all":
        return (
          <AdminCustomerManagementSection
            customers={allCustomers}
            onViewDetails={setViewingCustomer}
            onToggleBlock={onToggleCustomerBlock}
          />
        );
      case "customers_groups":
        return <AdminCustomerGroupsSection />;
      case "customers_wishlist":
        return <AdminWishlistsSection wishlistAnalytics={wishlistAnalytics} />;
      case "customers_feedback":
        return (
      ...
      case "marketing_email":
        return <AdminEmailCampaignsSection />;
      case "marketing_push":
        return <AdminPushNotificationsSection />;
      case "marketing_social":
        return <AdminSocialAdsSection />;
      case "reviews_all":
        return (
          <AdminReviewsSection
            reviews={reviews}
      ...
      case "cms_sliders":
        return (
          <AdminHeroSliderSection
            slides={heroSlides}
            onSave={onSaveHeroSlide}
      ...
      case "cms_banners":
        return (
          <AdminShoppableVideosSection
            initialVideos={shoppableVideos}
            onSave={onSaveShoppableVideo}
            onDelete={onDeleteShoppableVideo}
      ...
      case "cms_blog":
        return (
          <AdminBlogSection
            pages={cmsPages.filter((p) => p.type === "post")}
      ...
      case "cms_pages":
        return (
          <AdminCustomPagesSection
            initialPages={cmsPages.filter((p) => p.type === "page")}
            onSavePage={onSaveCmsPage}
            onDeletePage={onDeleteCmsPage}
            mediaLibrary={mediaLibrary}
            onUploadMedia={onUploadMedia}
      ...
      case "cms_floating_info":
        return (
          <AdminFloatingInfoSection
            items={floatingInfo}
            onSave={onSaveFloatingInfo}
            onDelete={onDeleteFloatingInfo}
          />
        );
      ...
      case "shipping_zones":
        return (
          <AdminShippingSection
            ...
            onSaveZone={onSaveShippingZone}
            onSaveProvider={onSaveShippingProvider}
          />
        );
      ...
      case "payments_logs":
        return (
          <AdminPaymentsSection
            ...
            onSaveGateway={onSavePaymentGateway}
          />
        );
      ...
      case "users_roles":
        return (
          <AdminRolesSection
            ...
            onSaveUser={onSaveAdminUser}
            onDeleteUser={onDeleteAdminUser}
          />
        );
      case "users_history":
        return <AdminSecuritySection />;
      ...
      case "settings_store":
        ...
        return (
          <AdminStoreSettingsSection
            storeSettings={siteSettings.storeSettings}
            onSaveStoreSettings={(s: StoreSettings) =>
              onSaveSiteSettings({ storeSettings: s })
            }
          />
        );
      case "settings_header":
        if (!siteSettings) return <p>Loading settings...</p>;
        return (
          <AdminHeaderManagerSection
            headerLinks={siteSettings.headerLinks}
            onSaveHeaderLinks={(links: NavLinkItem[]) =>
              onSaveSiteSettings({ headerLinks: links })
            }
          />
        );
      case "settings_footer":
        if (!siteSettings) return <p>Loading settings...</p>;
        return (
          <AdminFooterManagerSection
            footerSettings={siteSettings.footerSettings}
            onSaveFooterSettings={(fs: FooterSettings) =>
              onSaveSiteSettings({ footerSettings: fs })
            }
          />
        );
      case "settings_seo":
        ...
        return (
          <AdminSeoSettingsSection
            seoSettings={siteSettings.seoSettings}
            onSaveSeoSettings={(ss: SeoSettings) =>
              onSaveSiteSettings({ seoSettings: ss })
            }
          />
        );
      case "settings_theme":
        if (!siteSettings) return <p>Loading settings...</p>;
        return (
          <AdminThemeSettingsSection
            themeSettings={siteSettings.themeSettings}
            onSaveThemeSettings={(ts: ThemeSettings) =>
              onSaveSiteSettings({ themeSettings: ts })
            }
          />
        );
      case "settings_integrations":
        ...
        return (
          <AdminIntegrationsSection
            integrations={siteSettings.integrations}
            onSaveIntegrations={(i: IntegrationsSettings) =>
              onSaveSiteSettings({ integrations: i })
            }
          />
        );

      case "admin_profile":
        return <AdminProfileSection user={currentUser} />;
      ...
      case "support_tickets":
        return (
          <AdminSupportTicketsSection
            ...
            onSaveTicket={onSaveSupportTicket}
          />
        );
      case "support_help":
        return (
